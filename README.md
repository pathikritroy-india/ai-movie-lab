...
- **[The replication guide (PDF, V1.4)](guide/Sui_Dhaaga_AI_Film_Lab_Guide_V1_4.pdf)** - the full teaching case study: table of contents, every prompt, the continuity bible, the storyboard, tool decisions, corrections, publication workflow, and an instructor debrief. Written so a beginner can repeat the whole project. (Earlier editions [V1.3](guide/Sui_Dhaaga_AI_Film_Lab_Guide_V1_3.pdf) and [V1.2](guide/Sui_Dhaaga_AI_Film_Lab_Guide_V1_2.pdf) kept for version history.)
